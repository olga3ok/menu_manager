# Generated by Django 4.2.19 on 2025-02-11 17:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional', models.ManyToManyField(blank=True, related_name='additional_from', to='menu_manager.food', verbose_name='Дополнительные товары')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='food', to='menu_manager.foodcategory', verbose_name='Раздел меню')),
            ],
            options={
                'abstract': False,
            },
